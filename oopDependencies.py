...
class bird():
    def __init__(self, wings = 2, feet = 2, danger = 5):
        ...
        self.feet = feet
        self.danger = danger
    def __repr__(self): #does not seem to be causing the issue, experimented with normal return 
         pass
...
class dodo(bird):
    def __init__(self,wings = 2,feet = 2,danger = 4):
        super().__init__(self,wings,feet,danger)
    def __repr__(self) -> str:
        return f"I am a dodo, I have {self.wings} wings, {self.feet} feet and I am a {self.danger} on the danger scale, murgggh."
